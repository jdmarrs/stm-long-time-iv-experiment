...
the IV Curve text files created by the "Tapping_IV_browser - log - 4Gfit copy - Modified for Saving IV Files.vi"
LabVIEW Program. It opens IT text files with two columns [Time (Seconds), Current (nA)] and creates a plot
using Matplotlib.
