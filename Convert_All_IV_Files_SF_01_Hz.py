#===============================================================================
# Convert_All_IV_Files_SF_01_Hz.py
...
# Iteratively calls "IV_to_IT_File_Conversion_SF_01_Hz.py" to convert each IV file in the "IV Curves" folder from Voltage to Time, and save new files in the "IT Curves" folder.
#     "IV_to_IT_File_Conversion_SF_01_Hz.py" Opens IV text file with two columns (voltage, current) and convert voltage to time (V --> Seconds) using voltage sweep frequency (Hz) and range (V).
...
subscript_name = "IV_to_IT_File_Conversion_SF_01_Hz.py"
